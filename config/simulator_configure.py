...
class HM3DConfig:
    """
    TODO: write configuration for HM3D dataset
...
class ReplicaConfig:
    ...
    ## specify dataset ##
    _dataset_path = Path(__file__).parents[1] / "data" 
    scene = _dataset_path / "scene_datasets" / "replica_v1" / "apartment_0" / "habitat" /"mesh_semantic.ply"
    replica_scene_dataset = _dataset_path / "scene_datasets" / "replica_v1.scene_dataset_config.json"
